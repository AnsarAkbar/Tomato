      ...
      <div className="flex gap-10">
        {food_list.map((value, index) =>
          category === "All" || category.menu_name === value.category ? (
            <div key={index} className="rounded-2xl overflow-hidden shadow-xl relative hover:scale-105 duration-200">
              <img src={value.image} alt={value.name} className="w-full"/>
              <img src={assets.add_icon_white} alt="add_icon" className="absolute z-10 top-1/2 right-5 cursor-pointer"/>
              <div className="p-5">
